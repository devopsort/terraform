...
- Una vez subida la imagen del microservicio a ECR y el nuevo deployment yaml file en el repo argocd correspondiente, Argocd realiza las siguientes tareas:
